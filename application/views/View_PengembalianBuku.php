<body style="background-color: #CBE3FF; margin-left: 0px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
    <div class="d-flex justify-content-center">
        <div class="border" style="border: 1px solid; width: max-content; padding-right: 40px; padding-left: 40px; padding-top: 40px; padding-bottom: 40px; margin-top: 180px;border-radius: 5px;">
