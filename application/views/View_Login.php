...
<div class="container1" id="container">
    ...
    <div class="form-container log-in-container overlay-container overlay-right">
        <form method="post" class="form1" action="<?php echo site_url('Welcome/login') ?>" >
            ...
            <input class="input1" name="Password" type="password" placeholder="Password" required="required"><br>
